...
section .data
    ...
    fmt3 db 10, "Divide, round up:", 10,0
    fmt4 db 10, "Divide, round down:", 10,0
    fmt5 db 10, "Divide, truncate:", 10,0
    fmt6 db 10, "Divide, truncate:",10,0
    
    f_div db "%.f divided by %.1f is &.16f, in hex: ",0
    f_before dq 10, "mxcsr before:", 9,0
...
; default mxcsr
    ...
    mov rdx, three
    mov ecx, [default_mxcsr]
    call apply_mxcsr; division with precision
;round up
    mov rdi, fmt4
    mov rsi, eleven
    mov rdx, three
