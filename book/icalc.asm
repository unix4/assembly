...
; adding.......................
    ...
    ; subtracting...............
    mov rax, [number1]
    sub rax, [number2] ; subract number 2 from rax
    mov [resulti], rax
    ; displaying the result
    mov rdi, fmtint
    mov rsi, difi
...
;decrementing............
    ...
    mov rax, 0
    call printf
;shift arighmetic left---------------------
    mov rax, [number1]
    sal rax, 2 ; multiplay rax by 4
    mov [resulti], rax
    ; displaying the result
    mov rdi, fmtint
    mov rsi, sali
...
; shift arithmetic right................
    ...
    mov rax, 0
    call printf
; shift aritmetic right with sign extension .........
    mov rax, [neg_num]
    sar rax, 2 ; divide rax by 4
    mov [resulti], rax
    ; displaying the result
...
;multiply.........................
    mov rax, [number1]
    imul qword [number2] ; multiplay rax with number2
    mov [resulti], rax
    ; displaying the result
    mov rdi, fmtint
    mov rsi, multi
